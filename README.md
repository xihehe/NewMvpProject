...
CompressUtils.getInstance().ComprossImageList(PickPhotoActivity.this, 
mFils,0,com.example.fc.newmvpproject.Utils.FileUtils.getInst().getZipPic(), new ICompress() {
