...
public class CustomDialogFragement extends DialogFragment {
    ...
    public static CustomDialogFragement newInstance(String title, String message) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View dialogView = inflater.inflate(R.layout.dialog_myself_normal, null, false);
    ...
    public void setTitleAndMsg(String titleStr,String messageStr){
