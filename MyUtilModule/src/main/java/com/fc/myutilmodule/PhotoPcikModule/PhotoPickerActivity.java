package com.fc.myutilmodule.PhotoPcikModule;
...
import com.fc.myutilmodule.PhotoPcikModule.adapters.FloderAdapter;
import com.fc.myutilmodule.PhotoPcikModule.adapters.PhotoAdapter;
import com.fc.myutilmodule.PhotoPcikModule.beans.Photo;
import com.fc.myutilmodule.PhotoPcikModule.beans.PhotoFloder;
import com.fc.myutilmodule.PhotoPcikModule.utils.LogUtils;
import com.fc.myutilmodule.PhotoPcikModule.utils.OtherUtils;
import com.fc.myutilmodule.PhotoPcikModule.utils.PhotoUtils;
...
public class PhotoPickerActivity extends BaseActivity implements PhotoAdapter.PhotoClickCallBack {
    ...
    /** 相机 */
    public final static int MODE_CAMERA = 2;
    /** 默认最大选择数量 */
    ...
    public static final int PICK_PHOTO_MORE = 200;
...
//        dismissProgressDialog();
        ...
        final List<PhotoFloder> folders = new ArrayList<>();
        for (String key : keys) {
            if (ALL_PHOTO.equals(key)) {
                PhotoFloder folder = mFolderMap.get(key);
     ...
     * @param folders
     */
    private void toggleFolderList(final List<PhotoFloder> folders) {
        //初始化文件夹列表
     ...
     * @param photoFolder
     */
    public void selectFolder(PhotoFloder photoFolder) {
    ...
    private void showCamera() {
        ...
        if(cameraIntent.resolveActivity(getPackageManager()) != null){
            ...
            cameraIntent.putExtra(MediaStore.EXTRA_OUTPUT,getUriForFile(PhotoPickerActivity.this,mTmpFile));
    ...
    private static Uri getUriForFile(Context context, File file) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(context.getApplicationContext(), "com.puluo.yibu.fileprovider", file);
        } else {
