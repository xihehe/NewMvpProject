    ...
    private void initMultiMode() {
        ...
        mOnPhotoClick = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String path = v.findViewById(R.id.imageview_photo_Layout).getTag().toString();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(getItemViewType(position) == TYPE_CAMERA) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.imgpick_item_camera_layout, null);
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(
                        R.layout.imgpick_item_photo_layout, null);
                holder.photoImageViewLayout = (FrameLayout) convertView.findViewById(R.id.imageview_photo_Layout);
            ...
            if(mSelectMode == PhotoPickerActivity.MODE_MULTI) {
                ...
                holder.photoImageViewLayout.setTag(photo.getPath());
            ...
            ((BaseActivity)mContext).loadImgReSize(photo.getPath(),holder.photoImageView,mWidth, mWidth);
//            Sketch.with(mContext).display(photo.getPath(),holder.photoImageView).resize(mWidth, mWidth).commit();
    ...
    private class ViewHolder {
        private FrameLayout photoImageViewLayout;
